        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupLinkId = table.Column<Guid>(nullable: true),
                    SignIn = table.Column<DateTime>(nullable: true),
                    SignOut = table.Column<DateTime>(nullable: true),
                    BookingReference = table.Column<Guid>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                    PickUp = table.Column<bool>(nullable: false),
                    IsAdultSlot = table.Column<bool>(nullable: false),
                    IsKidSlot = table.Column<bool>(nullable: false),
                    IsToddlerSlot = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CancelledBookings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
